...
class OrderListViewModel : ViewModel() {
    ...
    private var _orderList = MutableLiveData<ArrayList<OrderList>>() //변경 가능한 mutableLiveData 변수
    val orderList : LiveData<ArrayList<OrderList>> get() = _orderList //LiveData 변수인 newsList는 변경이 안되므로 변경 가능한 _newsList를 가져옴
